    ...
    return (
        <div className={styles["social-media"]}>
            ...
            <div className={styles["social-media--content"]}>
                <a className={styles["social-media--item"]} href="https://www.facebook.com/ASICSBrasil" target="_blank">
                ...
                <a className={styles["social-media--item"]} href="https://www.instagram.com/asicsbrasil/" target="_blank">
                ...
                <a className={styles["social-media--item"]} href="https://www.youtube.com/channel/UCxb9TIwaWx6sGjfOdEWoZDA" target="_blank">
                ...
                <a className={styles["social-media--item"]} href="https://www.linkedin.com/company/asics-latin-america/" target="_blank">
