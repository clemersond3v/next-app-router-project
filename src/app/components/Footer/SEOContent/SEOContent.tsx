...
const SEOContent: React.FC = () => {
    return (
        <div className={styles["footer-seo-container"]}>
            <div className={styles["footer-seo"]}>
                <div className={styles["footer-seo--icon"]}>
                ...
                <div className={styles["footer-seo-content"]}>
                    <h3 className={styles["footer-seo-content--title"]}>Eleve sua performance com a ASICS</h3>
                    <p className={styles["footer-seo-content--subtitle"]}>Tênis de corrida, tênis de treino, roupas esportivas, acessórios e mais.</p>
                    <p className={styles["footer-seo-content--text"]}>Desde 1949 nosso objetivo é melhorar o bem estar mental por meio do movimento. É por isso que somos chamados de ASICS, que é um acrônimo para a frase em latim &quot;Anima Sana in Corpore Sano&quot;, mente sã em corpo são.</p>
                </div>
            </div>
        </div>        
    );
