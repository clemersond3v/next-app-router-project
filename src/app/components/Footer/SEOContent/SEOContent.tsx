const SEOContent: React.FC = () => {
    return (
        <div className="bg-bglight300">
            <div className="max-w-container flex flex-col items-center m-auto w-full p-5 text-center xl:p-8">
                <div>
                ...
                <div className="max-w-sm">
                    <h3 className="my-6 text-2xl font-semibold xl:my-4">Explore Novos Mundos com a BookVerso</h3>
                    <p className="my-4 font-semibold text-sm mb-4">Livros de ficção, não ficção, autoajuda, clássicos, best-sellers e muito mais.</p>
                    <p className="text-sm">Acreditamos no poder transformador da leitura. Na BookVerso, cada livro é um portal para o conhecimento, para novas ideias e para grandes histórias. Descubra sua próxima leitura e embarque nessa jornada literária.</p>
                </div>
            </div>
        </div>        
    );
